...
public class PaperDetail extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mProgressbar = (ProgressBar) findViewById(R.id.paper_detail_head_progress);

		//url = getIntent().getStringExtra("url");
		title = getIntent().getStringExtra("title");
		
		mBack = (ImageView) findViewById(R.id.paper_detail_back);
        mBack.setOnClickListener(UIHelper.finish(this));

        mTitle = (TextView) findViewById(R.id.paper_detail_head_title);
